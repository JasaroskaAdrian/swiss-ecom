    ...
    <>
      <article className="overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-soft">
        ...
        <div className="p-4">
          ...
          ws<p className="mt-1 text-white/60 text-sm">{inStock}</p>
          <div className="mt-3 flex items-center justify-between">
            <span className="text-lg font-semibold">{priceCHF}</span>
            <button className="rounded-lg bg-accent px-3 py-1.5 text-sm font-semibold text-black hover:opacity-95">
              Add to Cart
            </button>        
          </div>
        </div>
