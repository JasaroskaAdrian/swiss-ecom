    ...
    <header className="py-4">
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-4">
          ...
          <form className="ml-auto hidden w-full max-w-xl items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 py-2 shadow-soft backdrop-blur sm:flex" role="search">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 shrink-0 text-white/60" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          <nav className="ml-2 flex items-center gap-2">
            <a href="/login" className="rounded-xl bg-white/10 px-4 py-2 text-sm hover:bg-white/15">
              Login
            </a>
        ...
        <form className="mt-3 flex w-full items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 py-2 shadow-soft backdrop-blur sm:hidden" role="search">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 shrink-0 text-white/60" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
